...
from viz import pyramid_trigrid_widget
...
class Visualizer(imgui_window.ImguiWindow):
    def __init__(self, capture_dir=None):
        ...
        self.pyramid_trigrid_widget     = pyramid_trigrid_widget.PyramidTrigridWidget(self)
    ...
    def draw_frame(self):
        ...
        self.pyramid_trigrid_widget(expanded)
