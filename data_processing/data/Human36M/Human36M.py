...
class Human36M(torch.utils.data.Dataset):
    def __init__(self, transform, data_split):
        ...
        self.human_bbox_root_dir = osp.join(cfg.data_dir, 'Human36M', 'rootnet_output', 'bbox_root_human36m_output.json')
    ...
    def __getitem__(self, idx):
        ...
        if self.data_split == 'train':
            ...
            meta_info = {'orig_joint_valid': h36m_joint_valid, 'orig_joint_trunc': h36m_joint_trunc, 'fit_param_valid': smpl_param_valid, 'fit_joint_trunc': smpl_joint_trunc, 'is_valid_fit': float(is_valid_fit), 'bbox': bbox,
                         'is_3D': float(True)}
