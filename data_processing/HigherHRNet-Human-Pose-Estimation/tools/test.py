...
def main():
    ...
    for i, image_path in enumerate(glob.glob('F:/full-head-dataset\skeleton_estimation/3DCrowdNet_RELEASE\demo\my_input\images/*')):
        img = cv2.imread(
            image_path,
    ...
    with open('F:/full-head-dataset\skeleton_estimation/3DCrowdNet_RELEASE\demo\my_input/2d_pose_result_hrnet.json', 'w') as f:
        json.dump(results, f)
