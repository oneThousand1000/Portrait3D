...
class DensePoseMethods:
    def __init__(self):
        #
        ALP_UV = loadmat(os.path.join(os.path.dirname(__file__), './DensePoseData/UV_Processed.mat'))
        ...
        UV_symmetry_filename = os.path.join(os.path.dirname(__file__),
                                            './DensePoseData/UV_symmetry_transforms.mat')
    ...
    def IUV2FBC(self, I_point, U_point, V_point):
        ...
        #
        print('np.array([U_point, V_point])',np.array([U_point, V_point]).shape)
