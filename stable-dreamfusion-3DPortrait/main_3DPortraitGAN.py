...
if __name__ == '__main__':
    ...
    parser.add_argument('--trigrid_lr_ratio',type=float, nargs='+', default=[100,100,100,100,20,20,20], help="stable diffusion time steps range")
    ...
    parser.add_argument('--radius_range', type=float, nargs='*', default=[2.6, 2.8], help="training camera radius range")
    parser.add_argument('--theta_range', type=float, nargs='*', default=[60, 105], help="training camera range along the polar angles (i.e. up and down). See advanced.md for details.")
    ...
    parser.add_argument('--fovy_range', type=float, nargs='*', default=[11, 13], help="training camera fovy range")
